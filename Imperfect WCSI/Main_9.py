...
for ind_sample in tqdm(range(0, num_samples)):
    ...
    # =====================================================
    # Fig. 9(a): D(p0 || p1)
    # Rate maximization under D01 covertness constraint
    # =====================================================
    ...
    # =====================================================
    # Fig. 9(b): D(p1 || p0)
    # Rate maximization under D10 covertness constraint
    # =====================================================
