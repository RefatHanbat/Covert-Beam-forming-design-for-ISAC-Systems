...
# =====================================================
# x-axis values for Fig. 13
# Mutual information threshold gamma
# =====================================================
...
R_B_D01_result = np.zeros(np.size(gamma_cand))

R_B_D10_result = np.zeros(np.size(gamma_cand))
...
for ind_gamma in range(0, np.size(gamma_cand)):


    # =====================================================
    # Update gamma and gamma_SINR
    # =====================================================

    gamma = gamma_cand[ind_gamma]

    sys_param["gamma_MI"] = gamma
    ...
    R_B_D01_result[ind_gamma] = np.nanmean(R_B_D01_temp)

    R_B_D10_result[ind_gamma] = np.nanmean(R_B_D10_temp)


    print("===================================")

    print("gamma =", sys_param["gamma_MI"])

    print("gamma_SINR =", sys_param["gamma_SINR"])

    print("R_B D01 =", R_B_D01_result[ind_gamma])

    print("R_B D10 =", R_B_D10_result[ind_gamma])
